...
- **Valor Arbitrado - JZ (juiz/sentença)**: se a sentença do juiz fixar o valor (fora do fluxo DE/CM), registrar aqui. O campo `VALOR ARBITRADO` continua priorizando CM > DE > JZ, mas o valor JZ fica preservado para auditoria.
